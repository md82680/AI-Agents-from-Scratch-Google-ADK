...
## Conda Environment
To work with this project, activate the 'AI_Agent_withADK'

```bash
conda activate AI_Agent_withADK
...
Need help or run into issues? Join Brandon Hancock's free AI Developer Accelerator community on Skool:
...
AI-Agents-from-Scratch-Google-ADK
```